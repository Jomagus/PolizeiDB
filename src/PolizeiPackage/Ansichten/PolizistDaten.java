...
public class PolizistDaten {
    ...
    private StringProperty Dienstgrad;

    public PolizistDaten(int ID, String Na, String Ge, String Nat, String Gesch, String To, String Di) {
        ...
        Dienstgrad = new SimpleStringProperty(Di);
    }
    ...
    public StringProperty dienstgradProperty() {
        return Dienstgrad;
    }

    public void setDienstgrad(String dienstgrad) {
        this.Dienstgrad.set(dienstgrad);
    }
}
