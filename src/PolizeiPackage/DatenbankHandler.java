...
public class DatenbankHandler {
    ...
    private void VerbindeDatenbank() {
        try {
            ...
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS PERSON(\n" +
                    ...
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS POLIZIST(\n" +
                    "  PersonenID INTEGER PRIMARY KEY,\n" +
                    "  Dienstgrad TEXT NOT NULL,\n" +
                    "  FOREIGN KEY (PersonenID) REFERENCES PERSON(PersonenID) ON UPDATE CASCADE ON DELETE CASCADE\n" +
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS ART(\n" +
                    "  ArtID INTEGER PRIMARY KEY ,\n" +
                    "  Name TEXT NOT NULL,\n" +
                    "  Beschreibung TEXT NOT NULL\n" +
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS BEZIRK(\n" +
                    "  BezirksID INTEGER PRIMARY KEY,\n" +
                    "  Name TEXT NOT NULL\n" +
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS BEHÖRDE(\n" +
                    ...
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS FALL(\n" +
                    "  FallID INTEGER PRIMARY KEY ,\n" +
                    "  Name TEXT NOT NULL ,\n" +
                    "  Eröffnungsdatum TEXT NOT NULL , -- SQLites Date-Funktion(en) agieren auf Datumsstrings\n" +
                    "  Enddatum TEXT\n" +
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS VERBRECHEN(\n" +
                    ...
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS INDIZ(\n" +
                    ...
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS NOTIZ(\n" +
                    ...
                    "  FOREIGN KEY (angelegt_zu_FallID) REFERENCES FALL(FallID) ON UPDATE CASCADE ON DELETE RESTRICT\n" +
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS SIND_OPFER(\n" +
                    ...
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS SIND_VERDÄCHTIGE(\n" +
                    "  PersonenID INTEGER NOT NULL ,\n" +
                    "  VerbrechensID INTEGER NOT NULL ,\n" +
                    ...
                    "  FOREIGN KEY (VerbrechensID) REFERENCES VERBRECHEN(VerbrechensID) ON UPDATE CASCADE ON DELETE RESTRICT\n" +
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS LIEGT_IN(\n" +
                    ...
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS ARBEITEN(\n" +
                    "  PersonenID INTEGER NOT NULL ,\n" +
                    ...
                    ");");
            AnfrageObjekt.executeUpdate("CREATE TABLE IF NOT EXISTS ARBEITEN_AN(\n" +
                    "  PersonenID INTEGER NOT NULL ,\n" +
